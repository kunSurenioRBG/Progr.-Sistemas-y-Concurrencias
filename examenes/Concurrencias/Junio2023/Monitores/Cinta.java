...
public class Cinta {
	...
	public synchronized void poner(boolean primeraClase) throws InterruptedException {
		if (primeraClase == true) {
			...
			maletasPrimera++;
			primeraEsperando++;
			System.out.println("Generador pone maleta de primera clase. Total primera: " + maletasPrimera
					+ " Total turista: " + maletasTurista);
			primeraVaRetirar = true;
			notifyAll();
		} else {
			// turista
			maletasTurista++;
			System.out.println("Generador pone maleta de clase turista. Total primera: " + maletasPrimera
					+ " Total turista: " + maletasTurista);
